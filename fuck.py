...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            GHOST ATTACK
\033[1;37m Facebook:            Xan's
\033[1;37m Github  :            GHOST ATTACK 
...
def sarfraz():   
    ...
    print(f'[W] Follow my Facebook page ')
    print(f'[F] join my Facebook group ')
    print('')
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://facebook.com/groups/1820329801768883/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +SOHEL)
    os.system('sort -r '+ssb+' | uniq > '+SOHEL)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + SOHEL )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
